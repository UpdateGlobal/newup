...
<body class="my-body" data-spy="scroll" data-target="#main-navbar" data-offset="70">
    ...
    <div class="row">
        <img src="img/log1.png" alt="" class="fiximg">
    </div>
...
?>
  ...
  <video autoplay="autoplay" loop="loop" id="video_background" preload="auto" volume="50" class="responsive-video adaptvideo" />
...
<div class=""> 
    ...
    <section id="horizontal" class="">
        ...
        <div class="jumbotron text-center" style="background: url('img/web2.png') repeat center;" data-paroller-factor="-4" data-paroller-direction="horizontal">
            <div class="card-block addcard container" align="left">
                <h1 class="py-5 text-white thin">http://frelatos.pe/</h1>
                <p class="text-white thin">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
