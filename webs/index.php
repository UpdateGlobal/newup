...
<div class="row" align="left">
  ...
  <div class="fixed-action-btn vertical click-to-toggle">
      ...
      <ul>
        <li><a href="#webfor" class="btn-floating colormenu4 tooltipped" data-position="left"  data-delay="50" data-tooltip="Contacto" data-activates="slide-out"><i class="material-icons">perm_phone_msg</i></a></li>
  ...
  <!--slidervideo-->
    ...
    <video class="responsive-video" autoplay="" muted="" loop="loop" style="width: 100%; height: 80%;">
      <source src="slider-web-ani.mp4" type="video/mp4">
    </video>
  <!--slidervideo-->

  <!--efectmachiwrite-->
  <div style="background-color: #53bcbd; margin-top: 0px;" align="center">
    <div class="row" style="padding: 30px 30px 30px; margin-bottom: 0px; margin-top: -5px;">
  ...
  <div class="container-fluid" style="background-color: white; margin: 0px;">
    <div class="container" align="center" style="padding: 50px 0px;">
        <h3 class="uptext item_title" style="margin:0px; ">Casos de Exito</h3>  
        <p>Desarrollo Web</p>
        <br><br>
          ...
          <div class="col s12 m4 l5" id="contac"> 
            <div class="container" id="fromta">
             ...
             (function(w,d,u,b){w['Bitrix24FormObject']=b;w[b] = w[b] || function(){arguments[0].ref=u;
                  ...
                  b24form({"id":"17","lang":"la","sec":"2dz5dr","type":"inline"});
              </script>
