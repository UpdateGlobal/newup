  ...
  <body>
    ...
    <div style="background-color: #53bcbd; margin-top: 0px;" align="center">
      <div class="row" style="padding: 30px 30px 30px; margin-bottom: 50px;">
        ...
        <h2 class="uptextregular">Tendencias de Marketing</h2>
        <script type="text/javascript">
          $(function(){
            $("#typed").typed({
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col s12 m9">
          <div class="row">
            <?php
              $consultarNoticias = "SELECT * FROM noticias WHERE estado='1' ORDER BY fecha DESC";
            ...
            <?php
                ...
                $consultarNoticias = "SELECT * FROM noticias WHERE estado='1' ORDER BY fecha DESC $limite";
