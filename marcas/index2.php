...
<div class="row" style="display: inline-block;">
      ...
      <div class="col s6 thin">
            <h1 class="uptext" style=" color: #50bdbe;">Descripcion</h1>
...
<div class="col s6 offset-s6">
              <!-- Modal Trigger -->
              <a class="waves-effect waves-light chip modal-trigger" href="#modal123">Lista</a>
              ...
              <!-- Modal Trigger -->
              <a class="waves-effect waves-light chip modal-trigger" href="#modal">Modal</a>
              ...
              <!-- Modal Trigger -->
              <a class="waves-effect waves-light chip modal-trigger" href="#modals">Modal</a>
...
<div class="col s6 offset-s6">
              <!-- Modal Trigger -->
              <a class="waves-effect waves-light chip modal-trigger" href="#modal1">Modal1</a>
