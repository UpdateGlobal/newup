...
if($proceso == "Registrar"){
  ...
  $mensaje = "<div class='alert alert-success' role='alert'>
          ...
          <strong>Nota:</strong> La categor&iacute;a se registr&oacute; exitosamente. <a href='noticias-categorias.php'>Ir a categorias</a>
        </div>";
}
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "noticias-categorias-nuevo.php";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Publicar Categoria</button>
