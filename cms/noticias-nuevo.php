...
if($proceso == "Registrar"){
  ...
  $insertarNoticia = "INSERT INTO noticias(cod_categoria, titulo, slug, imagen, noticia, fecha, autor, estado)VALUE('$cod_categoria', '$titulo', '$slug', '$imagen', '$noticia', '$fecha', '$autor', '$estado')";
