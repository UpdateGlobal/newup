...
<head>
      ...
      <title>Update - Marketing Digital</title>
      ...
      <link href="https://fonts.googleapis.com/css?family=Fira+Sans+Extra+Condensed">
...
.colormenu4{background-color: #4db6ac;}
 ...
 <div class="fixed-action-btn vertical click-to-toggle">
    ...
    <ul>
      <li><a href="#formta" class="btn-floating colormenu4 tooltipped" data-position="left"  data-delay="50" data-tooltip="Contacto" data-activates="slide-out"><i class="material-icons">perm_phone_msg</i></a></li>
      <li><a href="https://api.whatsapp.com/send?phone=51934244258&text=Hola%20Me%20Gustaria%20información%20de%20sus%20servicios" target="new" class="btn-floating colormenu4 tooltipped" data-position="left"  data-delay="50" data-tooltip="Escribenos a Whatsapp">
        <img src="images/whatsapp.svg" width="27" style="color: white; padding-top: 6px;">
      </a></li>
      ...
      <li><a href="../" class="btn-floating colormenu4 tooltipped" data-position="left"  data-delay="50" data-tooltip="Ir al Inicio">
        <img src="images/home.svg" width="27" style="color: white; padding-top: 8px;">
      </a></li>    
    </ul>
  </div>
<!--menuluis-->
    ...
    <div class="slider hide-on-med-and-down">
      <ul class="slides">
        <li>
          <img src="images/empresario2.jpg"> 
          <div class="caption" style="padding: 20px; ">
            <h3 class="sd_ti">Atrae, seduce y convence a nuevos clientes</h3>
            <h5 class="sd_suti">MARKETING DIGITAL PARA TU EMPRESA</h5>
          </div>
        </li>
         <li>
    ...
    <div class="bg_v hide-on-med-and-up">
      <div class="caption" style="padding: 8px; margin-top: -55px;">
          <h3 class="sd_ti">Atrae, seduce <br><span class="tet"> y convence a nuevos clientes</span> </h3>
      </div>
    </div>
    ...
    <div style="background-color: #53bcbd; margin-top: -4px;" align="center">
      ...
      <h1 class="uptext">Estrategia de Marketing Digital en Lima - Perú<br><span class="gris" id="typed"></span></h1>
            <script type="text/javascript">
              $(function(){
                $("#typed").typed({
                  strings: ["Vende más en internet", "Consigue más clientes","Gana visibilidad", "Campañas en Google, Facebook y otras plataformas"],
                  typeSpeed: 30,
                  backDelay: 500,
                  loop: true,
                  loopCount: false,
        ...
        <div class="container-fluid bg_grey collapsible-header">
          <div class="row" style="margin-bottom: 0px;">
             <div class="col s12 m12">
              <h5 class="sd_suti_info">¿Qué plataformas puedo usar en mi <span class="verde">estrategia de Marketing Digital?<br> Entérate dando</span>  click AQUI <a href="#!" style="text-rendering: all;"></a> </h5>
            </div>
          </div>
        </div>
